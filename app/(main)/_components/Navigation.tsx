...
export const Navigation = () => {
    ...
    const sharedDocuments = useQuery(api.documents.getShared);
        ...
        <>
            <aside
                ref={sidebarRef} className={cn(
                    "group/sidebar bg-secondary overflow-y-auto relative flex w-60 flex-col z-[99999] h-screen",
                ...
                <div className="mt-4">
                    ...
                    {/* Shared Section */}
                    <div className="mt-4">
                        <div className="text-xs font-medium text-muted-foreground/80 px-3 mb-2">
                            Shared with me
                        </div>
                        <DocumentList
                            level={0}
            ...
            <div ref={navbarRef} className={cn("absolute top-0 z-[99999] left-60 w-[calc(100%-240%)]",
                isResetting && "transition-all ease-in-out duration-300",
